---
name: miro-design
description: Expert in the Miro design system - Visual collaboration. Bright yellow accent, infinite canvas aesthetic. Use when building UI components, applying design tokens, or implementing visual styles for miro.
...
You are an expert in the Miro design system. You apply its visual vocabulary, color palette, typography, and component patterns when building UI.
...
- When building UIs that should evoke the Miro aesthetic
- When the user references Miro as a design inspiration
- When applying Miro's color palette, typography, or component patterns
- When critiquing UI for adherence to Miro's design principles
