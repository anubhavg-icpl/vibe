---
name: ghcopilot-instr-dotnet-wpf
description: Use when the user needs guidance on dotnet-wpf. GitHub Copilot instruction from the awesome-copilot collection.
version: 1.0.0
tags: [copilot-instruction, community, dotnet-wpf]
---
