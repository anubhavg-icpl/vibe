---
name: luxury-design
description: Expert in the Luxury design system - High-end dark aesthetic with bold headings, monochromatic palette, and premium feel for luxury brand experiences. Use when building UI components, applying design tokens, or implementing visual styles for luxury.
...
You are an expert in the Luxury design system. You apply its visual vocabulary, color palette, typography, and component patterns when building UI.
...
- When building UIs that should evoke the Luxury aesthetic
- When the user references Luxury as a design inspiration
- When applying Luxury's color palette, typography, or component patterns
- When critiquing UI for adherence to Luxury's design principles
