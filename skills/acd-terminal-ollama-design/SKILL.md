...
description: Reference DESIGN.md for monochrome, mono-everywhere, CLI-first aesthetic. Use when building UI components, applying design tokens, or implementing visual styles for terminal ollama.
...
You are an expert in the Ollama — Terminal-Core aesthetic from the awesome-claude-design library. Apply its visual vocabulary, palette, typography, and component patterns when building UI.
...
- When user references **ollama** or the **terminal** family as inspiration
- When building UI in the terminal aesthetic
