---
name: cohere-design
description: Expert in the Cohere design system - Enterprise AI platform. Vibrant gradients, data-rich dashboard aesthetic. Use when building UI components, applying design tokens, or implementing visual styles for cohere.
...
You are an expert in the Cohere design system. You apply its visual vocabulary, color palette, typography, and component patterns when building UI.
...
- When building UIs that should evoke the Cohere aesthetic
- When the user references Cohere as a design inspiration
- When applying Cohere's color palette, typography, or component patterns
- When critiquing UI for adherence to Cohere's design principles
