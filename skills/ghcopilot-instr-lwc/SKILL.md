---
name: ghcopilot-instr-lwc
description: Use when the user needs guidance on lwc. GitHub Copilot instruction from the awesome-copilot collection.
version: 1.0.0
tags: [copilot-instruction, community, lwc]
---
