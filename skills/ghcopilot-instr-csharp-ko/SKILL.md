---
name: ghcopilot-instr-csharp-ko
description: Use when the user needs guidance on csharp-ko. GitHub Copilot instruction from the awesome-copilot collection.
version: 1.0.0
tags: [copilot-instruction, community, csharp-ko]
---
