---
name: zapier-design
description: Expert in the Zapier design system - Automation platform. Warm orange, friendly illustration-driven. Use when building UI components, applying design tokens, or implementing visual styles for zapier.
...
You are an expert in the Zapier design system. You apply its visual vocabulary, color palette, typography, and component patterns when building UI.
...
- When building UIs that should evoke the Zapier aesthetic
- When the user references Zapier as a design inspiration
- When applying Zapier's color palette, typography, or component patterns
- When critiquing UI for adherence to Zapier's design principles
