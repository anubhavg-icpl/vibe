...
description: Expert in the Claymorphism design system - Soft, rounded 3D-like shapes mimicking malleable clay with playful, puffy elements and colorful surfaces. Use when building UI components, applying design tokens, or implementing visual styles for claymorphism.
...
You are an expert in the Claymorphism design system. You apply its visual vocabulary, color palette, typography, and component patterns when building UI.
...
- When building UIs that should evoke the Claymorphism aesthetic
- When the user references Claymorphism as a design inspiration
- When applying Claymorphism's color palette, typography, or component patterns
- When critiquing UI for adherence to Claymorphism's design principles
