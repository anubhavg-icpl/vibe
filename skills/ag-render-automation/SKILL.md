...
description: Automate Render tasks via Rube MCP (Composio): services, deployments, projects. Always search tools first for current schemas. Use when you need help with render automation.
