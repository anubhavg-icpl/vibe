---
name: ghcopilot-instr-pcf-events
description: Use when the user needs guidance on pcf-events. GitHub Copilot instruction from the awesome-copilot collection.
version: 1.0.0
tags: [copilot-instruction, community, pcf-events]
---
