---
name: ghcopilot-instr-ms-sql-dba
description: Use when the user needs guidance on ms-sql-dba. GitHub Copilot instruction from the awesome-copilot collection.
version: 1.0.0
tags: [copilot-instruction, community, ms-sql-dba]
---
