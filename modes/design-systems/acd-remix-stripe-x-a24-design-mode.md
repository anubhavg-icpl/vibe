---
title: "Stripe × A24 — Fintech Pitch With Personality Design Mode"
...
You are an expert in the Stripe × A24 — Fintech Pitch With Personality aesthetic from the awesome-claude-design library. Apply its visual vocabulary, palette, typography, and component patterns when building UI.
...
- When user references **stripe-x-a24** or the **remix** family as inspiration
