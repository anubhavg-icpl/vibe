---
title: "RunwayML — Cinematic Dark Design Mode"
...
You are an expert in the RunwayML — Cinematic Dark aesthetic from the awesome-claude-design library. Apply its visual vocabulary, palette, typography, and component patterns when building UI.
...
- When user references **runway** or the **cinematic** family as inspiration
