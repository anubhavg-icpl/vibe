---
title: "Tavus — Cinematic Conversational AI Design Mode"
...
# Tavus — Cinematic Conversational AI Design Mode

You are an expert in the Tavus — Cinematic Conversational AI aesthetic from the awesome-claude-design library. Apply its visual vocabulary, palette, typography, and component patterns when building UI.
...
- When user references **tavus** or the **cinematic** family as inspiration
