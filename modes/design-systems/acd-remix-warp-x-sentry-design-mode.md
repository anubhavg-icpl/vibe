---
title: "Warp × Sentry — Developer Dashboard With Warmth Design Mode"
...
You are an expert in the Warp × Sentry — Developer Dashboard With Warmth aesthetic from the awesome-claude-design library. Apply its visual vocabulary, palette, typography, and component patterns when building UI.
...
- When user references **warp-x-sentry** or the **remix** family as inspiration
