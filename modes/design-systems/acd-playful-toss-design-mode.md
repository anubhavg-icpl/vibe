---
title: "Toss — Playful Fintech Design Mode"
...
You are an expert in the Toss — Playful Fintech aesthetic from the awesome-claude-design library. Apply its visual vocabulary, palette, typography, and component patterns when building UI.
...
- When user references **toss** or the **playful** family as inspiration
