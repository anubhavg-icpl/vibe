---
title: "Notion × Duolingo — Friendly Education SaaS Design Mode"
...
# Notion × Duolingo — Friendly Education SaaS Design Mode

You are an expert in the Notion × Duolingo — Friendly Education SaaS aesthetic from the awesome-claude-design library. Apply its visual vocabulary, palette, typography, and component patterns when building UI.
...
- When user references **notion-x-duolingo** or the **remix** family as inspiration
