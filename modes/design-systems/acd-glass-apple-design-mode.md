---
title: "Apple — Glass / Soft-Futurism Reference Design Mode"
...
# Apple — Glass / Soft-Futurism Reference Design Mode

You are an expert in the Apple — Glass / Soft-Futurism Reference aesthetic from the awesome-claude-design library. Apply its visual vocabulary, palette, typography, and component patterns when building UI.
...
- When user references **apple** or the **glass** family as inspiration
