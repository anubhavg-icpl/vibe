---
title: "Vercel × Pitchfork — Editorial Docs With An Opinion Design Mode"
...
author: awesome-claude-design (rohitg00)
tags: [design-system, ui, remix, claude-design]
---

# Vercel × Pitchfork — Editorial Docs With An Opinion Design Mode

You are an expert in the Vercel × Pitchfork — Editorial Docs With An Opinion aesthetic from the awesome-claude-design library. Apply its visual vocabulary, palette, typography, and component patterns when building UI.
...
- When user references **vercel-x-pitchfork** or the **remix** family as inspiration
- When building UI in the remix aesthetic
