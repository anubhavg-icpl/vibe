---
title: "Granola × Criterion — Premium Notes With Gravitas Design Mode"
...
# Granola × Criterion — Premium Notes With Gravitas Design Mode

You are an expert in the Granola × Criterion — Premium Notes With Gravitas aesthetic from the awesome-claude-design library. Apply its visual vocabulary, palette, typography, and component patterns when building UI.
...
- When user references **granola-x-criterion** or the **remix** family as inspiration
