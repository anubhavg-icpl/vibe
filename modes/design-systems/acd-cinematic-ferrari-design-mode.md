---
title: "Ferrari — Chiaroscuro Rosso Corsa Design Mode"
...
# Ferrari — Chiaroscuro Rosso Corsa Design Mode

You are an expert in the Ferrari — Chiaroscuro Rosso Corsa aesthetic from the awesome-claude-design library. Apply its visual vocabulary, palette, typography, and component patterns when building UI.
...
- When user references **ferrari** or the **cinematic** family as inspiration
