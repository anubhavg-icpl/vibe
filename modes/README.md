# AI Chat Modes Collection

A comprehensive collection of **73 specialized AI chat modes** for software engineering, architecture, analysis, development, cloud infrastructure, mobile development, blockchain, testing, databases, design, game development, and enterprise tools.
...
- **planning-mode.md** - Generate implementation plans for new features or refactoring
...
- **test-automation-engineer-mode.md** - Playwright, Cypress, Selenium, test frameworks
- **accessibility-testing-mode.md** - WCAG compliance, ARIA, screen readers, a11y auditing
- **performance-testing-mode.md** - Load testing, stress testing, k6, JMeter, APM
...
- **ux-researcher-mode.md** - User research, personas, journey mapping, usability testing
- **ui-designer-mode.md** - Visual design, Figma, design systems, responsive design
...
- **gcp-cloud-architect-mode.md** - Google Cloud Platform, BigQuery, Vertex AI, GKE, serverless
- **azure-solutions-expert-mode.md** - Microsoft Azure, Entra ID, Bicep, enterprise integration
- **terraform-iac-expert-mode.md** - Terraform, Infrastructure as Code, multi-cloud, state management
...
- **android-kotlin-developer-mode.md** - Android, Kotlin, Jetpack Compose, Material Design 3
- **react-native-developer-mode.md** - React Native, TypeScript, cross-platform mobile apps
...
- **web3-developer-mode.md** - Web3.js, ethers.js, dApp development, wallet integration
...
- **mongodb-expert-mode.md** - MongoDB, aggregation pipelines, sharding, NoSQL patterns
- **redis-expert-mode.md** - Redis caching, pub/sub, data structures, performance
...
- **java-spring-expert-mode.md** - Java, Spring Boot, microservices, enterprise patterns
- **golang-developer-mode.md** - Go, concurrency, goroutines, microservices
- **cpp-expert-mode.md** - C++17/20, performance, systems programming, modern features
- **php-laravel-mode.md** - PHP 8+, Laravel, Eloquent, modern web development
...
- **unreal-engine-mode.md** - Unreal Engine, C++, Blueprints, AAA game development
...
- **salesforce-developer-mode.md** - Apex, Lightning Web Components, Salesforce platform
...
- **json-yaml-specialist-mode.md** - JSON/YAML formatting, validation, schema design
- **documentation-generator-mode.md** - Technical documentation, API docs, OpenAPI
- **code-commenter-mode.md** - Code documentation, inline comments, docstrings
...
- **Active Development?** → Use Blueprint, Software Engineer Agent, or Claude Code Best Practices modes
- **Cloud Infrastructure?** → Use AWS, GCP, Azure, Terraform, or Kubernetes modes
- **Mobile Development?** → Use iOS, Android, React Native, or Flutter modes
- **Blockchain/Web3?** → Use Solidity, Web3, or DeFi modes
- **Testing?** → Use Test Automation, Accessibility, Performance Testing, or QA modes
- **Database Work?** → Use PostgreSQL, MongoDB, Redis, or SQL Optimization modes
- **Design/UX?** → Use UX Research, UI Design, Design System, or Accessibility Designer modes
- **Specific Language?** → Use Python, Java, Go, C++, PHP, or Ruby modes
- **Game Development?** → Use Unity, Unreal, or Game Design modes
- **Enterprise Tools?** → Use Power BI, Salesforce, or Atlassian modes
...
- **Data**: PostgreSQL, MongoDB, Redis, Power BI, Data Science
- **Blockchain**: Solidity, Web3, DeFi

## 🛡️ Best Practices

1. **Choose the Right Mode**: Select based on your current task phase (planning, implementation, review, deployment)
2. **Combine Modes**: Use planning modes before development modes for better outcomes
3. **Security First**: Always run security analysis modes before production deployments
4. **Quality Checks**: Use code quality and testing modes throughout development
5. **Documentation**: Generate specs and docs early in the development cycle
6. **Platform-Specific**: Use specialized modes for cloud platforms, mobile platforms, or specific languages
7. **Testing Strategy**: Combine unit testing, accessibility testing, and performance testing modes
8. **Infrastructure**: Use IaC modes (Terraform, cloud-specific) for repeatable deployments
...
2. Create the mode file following the established format:
   ...
   - Expertise areas with specific technologies
   - Best practices and standards
   - Code examples (where appropriate)
   - Decision frameworks
   - Communication style guidelines
3. Update this README with the new mode description
4. Follow existing naming conventions

## 📊 Statistics

- **Total Modes**: 73 specialized AI chat modes
- **Categories**: 20 distinct categories
- **Coverage**: Cloud, Mobile, Blockchain, Testing, Databases, Design, Languages, Games, Enterprise, and more
- **Code Examples**: Production-ready code in 15+ programming languages
- **Platforms**: AWS, GCP, Azure, iOS, Android, Web, Desktop, Blockchain
- **Netflix-Inspired Modes**: 4 modes with unique personality and expertise
...
**Last Updated**: 2025 | **Total Modes**: 73 across 20 categories
